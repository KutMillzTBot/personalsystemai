...
from ..adapters.brokers import PaperBroker, MT5Broker, RestBroker
...
class MainWindow(QMainWindow):
    ...
    def create_controls_panel(self, parent_layout):
        ...
        self.broker_combo.addItems(["PAPER", "MT5", "REST"])
    ...
    def on_connect(self):
        ...
        try:
            if broker_type == "PAPER":
                ...
                host = self.settings_manager.get('mt5_host', self.settings_manager.get('mt4_host', '127.0.0.1'))
                port = self.settings_manager.get('mt5_port', self.settings_manager.get('mt4_port', 5050))
                self.broker = MT5Broker(host, port)
